...
grep -q 'pub async fn status' "$ROOT_DIR/src/providers.rs"
grep -q 'pub async fn cancel' "$ROOT_DIR/src/providers.rs"
grep -q 'ACTION_REMINDER_CANCEL_URL' "$ROOT_DIR/src/providers.rs"
grep -q 'ACTION_MESSAGE_STATUS_URL' "$ROOT_DIR/src/providers.rs"
grep -q 'scoped_idempotency_key' "$ROOT_DIR/src/providers.rs"
grep -q 'command_idempotency_key' "$ROOT_DIR/src/action_effects.rs"
