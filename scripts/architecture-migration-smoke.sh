...
echo "architecture migration smoke passed: foundation tables, rate limits, deletion-aware changes, retrieval triggers, and idempotency metadata apply to a fresh SQLite database"
