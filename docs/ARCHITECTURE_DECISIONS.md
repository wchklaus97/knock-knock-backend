...
| D22 | Missing or ambiguous values require a follow-up question. | The model must not guess dates, people, amounts, permissions, or high-impact intent. | Fixtures with ambiguity produce clarification, never execution. | Prompt policy, strict low-confidence handling, and ambiguous/prompt-injection fixtures exist; real-model per-locale evidence remains. |
